...
WORKER_RESULT id=steward-od-6 branch=docs/oracle-plan-caption-split-aliases worktree=<repos_root>/find_best_mobo/.worktrees/steward-od-6 engine=claude exit=0 commits=1
...
WORKER_RESULT id=oracle-20260820104007 branch=docs/oracle-2026-08-20-bl17 worktree=<repos_root>/find_best_mobo/.worktrees/oracle-20260820104007 engine=claude exit=0 commits=1
...
WORKER_RESULT id=steward-od-7 branch=worker/steward-od-7 worktree=<repos_root>/find_best_mobo/.worktrees/steward-od-7 engine=claude exit=0 commits=1
...
WORKER_RESULT id=oracle-20260820110210 branch=worker/oracle-20260820110210 worktree=<repos_root>/find_best_mobo/.worktrees/oracle-20260820110210 engine=claude exit=0 commits=1
