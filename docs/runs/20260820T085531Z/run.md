...
WORKER_RESULT id=oracle-20260820085541 branch=worker/oracle-20260820085541 worktree=<repos_root>/find_best_mobo/.worktrees/oracle-20260820085541 engine=claude exit=0 commits=1
...
WORKER_RESULT id=steward-od-6 branch=worker/steward-od-6 worktree=<repos_root>/find_best_mobo/.worktrees/steward-od-6 engine=claude exit=0 commits=1
...
WORKER_RESULT id=oracle-20260820090923 branch=worker/oracle-20260820090923 worktree=<repos_root>/find_best_mobo/.worktrees/oracle-20260820090923 engine=claude exit=0 commits=1
